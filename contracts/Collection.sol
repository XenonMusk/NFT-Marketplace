...
import "@openzeppelin/contracts/token/ERC721/ERC721.sol"; //simple contract required to create NFT
import "@openzeppelin/contracts/utils/Counters.sol"; //to keep track of our tokenIDs
import "@openzeppelin/contracts/access/Ownable.sol";//allows to use owner functions
import "@openzeppelin/contracts/token/ERC721/extensions/ERC721URIStorage.sol";//allows to store meta data on arraylist
...
contract Collection is ERC721URIStorage, Ownable {
    ...
    function mintNFT(string memory tokenURI) //tokenURI is a link to metadata of our NFT
        payable
        external
        returns (uint256)
    {
